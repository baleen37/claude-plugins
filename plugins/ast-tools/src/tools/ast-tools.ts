...
export interface AstToolDefinition<T extends z.ZodTypeAny> {
  name: string;
  description: string;
  schema: T;
  handler: (
 ...
 */
export const astGrepSearchTool: AstToolDefinition<z.ZodObject<{
  pattern: z.ZodString;
 ...
 */
export const astGrepReplaceTool: AstToolDefinition<z.ZodObject<{
  pattern: z.ZodString;
