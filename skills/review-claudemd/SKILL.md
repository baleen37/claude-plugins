...
description: This skill should be used when the user asks to "review CLAUDE.md", "improve CLAUDE.md", "analyze conversation history", "find CLAUDE.md improvements", or wants to update their global or local CLAUDE.md files based on recent interactions.
---
